...
if (isset($_POST["btnsubmit"])) {
    ...
    $sql = 'INSERT INTO tblemployee(employeeID,fullname,password,sex,email,dob,phone,address,qualification,dept,employee_type,date_appointment,basic_salary,gross_pay,status,photo) VALUES(:employeeID,:fullname,:password,:sex,:email,:dob,:phone,:address,:qualification,:dept,:employee_type,:date_appointment,:basic_salary,:gross_pay,:status,:photo)';
    $statement = $dbh->prepare($sql);
    $statement->execute([
        ':employeeID' => $employeeID,
        ':fullname' => $_POST['txtthe_fullname'],
        ':password' => $_POST['txtpassword'],
        ':sex' => $_POST['cmdsex'],
        ':email' => $_POST['txtemail@gmail.com'],
        ':dob' => '', // Assuming this will be filled later
        ':phone' => $_POST['txt_phonen'],
        ':address' => '', // Assuming this will be filled later
        ':qualification' => '', // Assuming this will be filled later
        ':dept' => $_POST['cmddept'],
        ':employee_type' => $_POST['cmdemployeetype'],
        ':date_appointment' => '', // Assuming this will be filled later
        ':basic_salary' => $_POST['txtbasic_salary'],
        ':gross_pay' => $_POST['txtgross_pay'],
        ':status' => '', //Assuming this will be filled later
...
<head>
    ...
    <link rel="icon" type="image/jpg" sizes="16x16" href="../image/badge1.jpg">
        ...
        <div class="row">
            ...
            <div class="form-holder" style="height: 100%;overflow-y: auto; max-height:unset;">
                ...
                <div class="form-content" style="max-height: unset;">
                    ...
                    <img src="image\badge1.jpg" alt="" class="logo-light" height="81">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-12 form-group mb-2">
                                            ...
                                            <select class="form-control" required data-validation-required-message="Select Employee Department" data-val="true" data-val-required="The Employee Department field is required." id="cmddept" name="cmddept">
                                                    ...
                                                    <option value="Management Technolgy">Management Technol0gy</option>
