...
<head>
	...
	<link rel="icon" type="image/png" sizes="16x16" href="image\badge1.jpg">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark nav-light">
        <div class="container">
            ...
            <a class="navbar-brand logo" href="index.html">
                <img src="image\badge1.jpg" alt="" class="logo-dark" height="50">
                <img src="image\badge1.jpg" alt="" class="logo-light" height="100">
            </a>
                ...
                <div class="hero-title">
                    <h1 class="hero-7-title">
                        <span class="text-wrapper">
                            <span class="text-light font-weight-normal">City Of Faith Employee Management System </span>                        </span>                    </h1>
                    <p class="text-light-70 mb-4 pb-2">
                    This Employee management system ensure workers perform their jobs to the 
                    best of their abilities so as to achieve goals of the school. This will entail building and maintaining 
            ...
            <div class="col-lg-5 offset-lg-1">
                <div class="hero-login-form mx-auto p-4 rounded mt-5 mt-lg-0 bg-white">
                    <div class="text-center">
                        <h5 class="form-title mb-4">Manage your employees Online!</h5>
                    </div>
                    <img src="images\connpic.jpg" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
        </div>
    </div>
